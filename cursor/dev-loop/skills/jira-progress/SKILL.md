...
Claude slash `/dev-loop` and SessionStart hooks do not run here. Same CLI: `python3 ~/.claude/hooks/dev-loop/cli.py`. Do not edit `skills/` in the repo; this tree is the Cursor copy.
